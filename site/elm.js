		...
		return A3(
			$joakin$elm_canvas$Canvas$toHtmlWith,
			{
				...
				textures: _List_fromArray(
					[
						A2($joakin$elm_canvas$Canvas$Texture$loadFromImageUrl, './kita-head.png', $author$project$Main$TextureLoadedHead),
						A2($joakin$elm_canvas$Canvas$Texture$loadFromImageUrl, './kita-tail.png', $author$project$Main$TextureLoadedTail)
					]),
				width: w
			},
			_List_Nil,
